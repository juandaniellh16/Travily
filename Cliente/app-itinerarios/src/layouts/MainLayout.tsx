    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <main className='flex-grow px-10'>
        <div className='grid max-w-6xl grid-cols-5 gap-4 mx-auto'>
          <div className='hidden md:block flex-col self-start items-center col-span-1 bg-neutral-100 rounded-xl overflow-hidden sticky top-[73px]'>
            <SideBar activeTab={activeTab} setActiveTab={setActiveTab} />
          </div>
          <div className='flex flex-col col-span-5 pb-6 rounded-xl md:col-span-3'>
            <Outlet context={{ activeTab, setActiveTab }} />
          </div>
          <div className='hidden md:block flex-col self-start items-center col-span-1 text-center bg-neutral-100 rounded-xl overflow-hidden sticky top-[73px]'>
