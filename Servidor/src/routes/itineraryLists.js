...
export const createItineraryListsRouter = ({ itineraryListModel }) => {
  ...
  itineraryListsRouter.get(
    "/:id/is-liked",
    itineraryListController.checkIfLiked,
  );

  itineraryListsRouter.post(
    "/:id/itineraries",
    itineraryListController.addItineraryToList,
  );
  itineraryListsRouter.delete(
    "/:id/itineraries",
    itineraryListController.removeItineraryFromList,
  );
